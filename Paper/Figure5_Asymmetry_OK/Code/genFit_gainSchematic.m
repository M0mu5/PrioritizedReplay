...
subplot(2,2,1); b1=bar(gain); ylim([-0.5 5]); b1.Parent.XTickLabel={'-1.0','0.5','3.0'}; b1.Parent.YTick = [0 1]; grid on; title('Update Q_1')
ylabel(sprintf('Prioritized\nReplay'))
ylabel(sprintf('Gain_{replay}'))
xlabel('Q-value after update')
subplot(2,2,3); b3=bar(PS); ylim([-0.5 5]); b3.Parent.XTickLabel={'-1.0','0.5','3.0'}; b3.Parent.YTick = [0 2]; grid on; %title('Update Q_1')
%ylabel(sprintf('Prioritized\nSweeping'))
...
subplot(2,2,2); b2=bar(gain); ylim([-0.5 5]); b2.Parent.XTickLabel={'-2.0','0.5','2.0'}; b2.Parent.YTick = [0 1]; grid on; title('Update Q_2')
xlabel('Q-value after update')
subplot(2,2,4); b4=bar(PS); ylim([-0.5 5]); b4.Parent.XTickLabel={'-2.0','0.5','2.0'}; b4.Parent.YTick = [0 2]; grid on; %title('Q_2=0')
xlabel('Q-value after update')
